...
from skav.transcripts.models.contents.tool_use import ToolUseContentItem
...
SAMPLE_TOOL_USE_READ: dict[str, Any] = {
    ...
    "name": "Read",
    "input": {
        "file_path": "/Users/root/workspace/project/transcripts/models.py",
    },
}
...
class TestToolUseContentItem:
    ...
    def test_required_fields_real_data(self) -> None:
        ...
        assert item.input["file_path"] == "/Users/root/workspace/project/transcripts/models.py"
